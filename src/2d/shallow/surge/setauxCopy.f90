!
subroutine setauxCopy(mbc,mx,my,xlow,ylow,dx,dy,maux,aux,auxflags)
!     ============================================
!
...
!     aux(pressure_index, i , j) = Pressure Field
    ...
    use friction_module, only: friction_index, set_friction_fieldCopy
    ...
    integer(kind=1), intent(inout) :: auxflags(1-mbc:mx+mbc,1-mbc:my+mbc)

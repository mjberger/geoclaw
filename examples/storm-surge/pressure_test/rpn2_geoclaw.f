...
C       use geoclaw_module, only: coordinate_system, spherical_distance
      ...
      double precision bR,bL,sL,sR,sRoe1,sRoe2,sE1,sE2,uhat,chat,pL,pR
...
c     &     hvL,hvR,bL,bR,uL,uR,vL,vR,phiL,phiR,sE1,sE2,drytol,g,sw,fw)
     ...
     &      bL,bR,uL,uR,vL,vR,phiL,phiR,sE1,sE2,drytol,pL,pR,g,sw,fw)

c-----------------------------------------------------------------------
     ...
     &   hvL,hvR,bL,bR,uL,uR,vL,vR,phiL,phiR,sE1,sE2,drytol,pL,pR,g,
     &   sw,fw)
      ...
      double precision delh,delhu,delphi,delb,delnorm,delp
...
c-----------------------------------------------------------------------
     ...
     &           bL,bR,uL,uR,vL,vR,phiL,phiR,s1,s2,drytol,pL,pR,g,sw,fw)
      ...
      double precision hL,hR,huL,huR,bL,bR,uL,uR,phiL,phiR,s1,s2,pL,pR
